...
public class Solution {
    public static void main(String[] args) {
        ...
        new Tree().info(new Integer("4").getClass());
        new Tree().info(new Short("4").getClass());
        new Tree().info(new BigDecimal("4").getClass());

        //Блок 3.
        //Вызов для Number (Задание 3)
        new Tree().info(new Integer("4").shortValue());
        new Tree().info(new Short("4").shortValue());
        new Tree().info(new BigDecimal("4").shortValue());
