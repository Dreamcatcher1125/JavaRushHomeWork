    ...
    public Sayable toSayable(final int i)
    {
        class CatPet implements Sayable
        {
            ...
            public String say()
            {
                ...
                {
                    StringBuilder miy = new StringBuilder(name + " говорит м"); // * @param i количество букв 'я' в слове мяу
                    for (int j = 0; j < i; j++)
                        miy.append("я");
                    return miy.append("у!").toString();
                }
            }
        }
        return new CatPet(); // * @return экземпляр класса CatPet
    }
}