...
public class Solution
{
    ...
    public static void main(String[] args) throws InterruptedException
    {
        ...
        Thread.sleep(3500); //ждем 3.5 с
        if (clock.isAlive()) // проверяет запущена ли нить clock
        {
            clock.interrupt(); // завершает нить и выкидывает исключение на Thread.sleep(1000);
        }
