...
public class Solution {
    public static int totalCountSpeeches = 200; // Общее кол-во выступлений
    public static int soundsInOneSpeech = 1000000; //звучит в одном выступлении
    ...
    public static class Politic extends Thread {
        private int countSounds; // количество слов
        ...
        public void run() {
            while (countSounds < totalCountSpeeches * soundsInOneSpeech) { // countSounds < 200 * 1000000
                countSounds++;
            }
        }
